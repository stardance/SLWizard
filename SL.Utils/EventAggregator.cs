...
namespace SL.Utils
{
    ...
    public class EventAggregator
    {
        ...
        private class HandleMethodWrapper
        {
            ...
            private readonly System.Reflection.MethodInfo _handlerMethod;
            ...
            public HandleMethodWrapper(System.Reflection.MethodInfo handlerMethod, Type listenerInterface, Type messageType, bool supportMessageInheritance)
            {
        ...
        internal static class TypeHelper
        {
            ...
            internal static System.Reflection.MethodInfo GetMethod(Type type, string methodName)
            {
#if NETFX_CORE
    ...
    public static class EventAggregatorHost
    {
        private static EventAggregator _Agg;
